	...
	window.JCCatalogElement.prototype = {
		...
		setCompared: function(state)
		{
            ...
            if (checkbox)
            {
                ...
                console.log(BX.message('CT_BCE_CATALOG_COMPARE_COMPARED'));
                if (state)
                    checkboxTitle.innerHTML = BX.message('CT_BCE_CATALOG_COMPARE_COMPARED');
                else
                    checkboxTitle.innerHTML = BX.message('CT_BCE_CATALOG_COMPARE');
            }
		},
